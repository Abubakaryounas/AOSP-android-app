...
public class PhotoViewFragment extends Fragment implements
    ...
    private void setViewVisibility() {
        final boolean fullScreen = mCallback != null && mCallback.isFragmentFullScreen(this);
    ...
    public interface HorizontallyScrollable {
        ...
        boolean interceptMoveLeft(float origX, float origY);
         ...
         * @param origY the raw y coordinate of the initial touch
         */
        boolean interceptMoveRight(float origX, float origY);
    }
