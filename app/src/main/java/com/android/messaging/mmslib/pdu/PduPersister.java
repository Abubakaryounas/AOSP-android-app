...
public class PduPersister {
        ...
        try {
            ...
            for (int i = 0; i < partsNum; i++) {
                ...
                if ((partUri == null) || TextUtils.isEmpty(partUri.getAuthority())
                        || !partUri.getAuthority().startsWith("app/src/main/java/android/support/v7/mms")) {
    ...
    public Cursor getPendingMessages(final long dueTime) {
        ...
        uriBuilder.appendQueryParameter("protocol", "app/src/main/java/android/support/v7/mms");
