...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    static {
        ...
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", null,         MMS_ALL);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "#",          MMS_ALL_ID);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "inbox",      MMS_INBOX);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "inbox/#",    MMS_INBOX_ID);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "sent",       MMS_SENT);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "sent/#",     MMS_SENT_ID);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "drafts",     MMS_DRAFTS);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "drafts/#",   MMS_DRAFTS_ID);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "outbox",     MMS_OUTBOX);
        URI_MATCHER.addURI("app/src/main/java/android/support/v7/mms", "outbox/#",   MMS_OUTBOX_ID);
