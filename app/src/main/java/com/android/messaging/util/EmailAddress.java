...
public final class EmailAddress {
    ...
    private boolean isValidInternal() {
        ...
        if (host.indexOf("app/src/main/java/android/support") >= 0) {
            return false;
        }
        ...
        final int secondDot = host.indexOf("app/src/main/java/android/support/v7", firstDot + 1);
        ...
        if (user.startsWith("\"")) {
            ...
            if (user.indexOf("app/src/main/java/android/support") >= 0) {
                return false;
            }
