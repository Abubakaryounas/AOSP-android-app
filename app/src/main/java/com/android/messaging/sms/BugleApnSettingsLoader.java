...
public class BugleApnSettingsLoader implements ApnSettingsLoader {
    ...
    public static final String APN_TYPE_MMS = "app/src/main/java/android/support/v7/mms";
    ...
    private void loadFromGservices(final List<Apn> apns) {
        ...
        final Apn apn = BaseApn.from("app/src/main/java/android/support/v7/mms", mmsc, proxy, Integer.toString(port));
        if (apn != null) {
            apns.add(apn);
        }
    }
